...
//    echo '</form>';
    ...
    echo '<button onclick="boldButton2(this.id)" class="astext yesno" id="yesno'.$count.'" value="yes" data-count="0"> Yes </button> <button onclick="boldButton2(this.id)" class="astext yesno" id="yesno'.$count.'" value="unsure" data-count="0"> Not sure </button> <button onclick="boldButton2(this.id)" id="yesno'.$count.'" class="astext yesno" value="no" data-count="0"> No </button> <br>';
    
    echo '<div id="yes-'.$count.'" style="display: none;"> <p>Why?</p><br><input type="checkbox" name="why'.$count.'[]" value="media">I like the attached media (photo/video/etc) <br><input type="checkbox" name="why'.$count.'[]" value="funny">It is funny<br> <input type="checkbox" name="why'.$count.'[]" value="person">I want to know what this person is doing</div>';

    echo '<div id="no-'.$count.'" style="display: none;"> <p>Why not?</p><br><input type="checkbox" name="whynot'.$count.'" value="uninterested">Not interested in the content<br> <input type="checkbox" name="whynot'.$count.'" value="dontunderstand">I don\'t understand the content<br><input type="checkbox" name="whynot'.$count.'" value="uninterested">Don\'t know the people involved<br></div>';
