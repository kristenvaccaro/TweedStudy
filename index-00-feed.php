...
<div class="instructions" id="header-footer">
    ...
    <div class="row" style="margin-bottom: 14px;">
        ...
        <div class="col-md-7">
            <h4 style="margin-left: 14px;  line-height: 1.5;">Imagine you are browsing this feed on a Sunday morning, while drinking coffee (or a similar leisurely browsing time). Please browse for a minimum of 30-60 seconds as you would in that situation.</h4>
        </div>';
        ...
        <div class="col-md-5">
            <h4 style="margin-left: 15px; margin-right: 15px; line-height: 1.5;">Controls are available for this news feed. Please use them for at least 10-20 seconds to make your ideal feed for a leisurely browsing time (e.g. a Sunday morning drinking coffee). Please try at least 3 control settings.</h4>
        </div>';
