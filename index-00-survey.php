    ...
    <div class="col-md-7">
        ...
        <div class="survey">
            ...
            <label class="statement">5. I would like to use an interface like this for my day-to-day browsing of my Twitter news feed.</label>
                <ul class="likert">
                                <li>
                <input type="radio" name="likert-'; echo $page_id; echo '-5" value="strong_disagree">
                <label>Strongly disagree</label>
                </li>

                <li>
                <input type="radio" name="likert-'; echo $page_id; echo '-5" value="disagree">
                <label>Disagree</label>
                </li>


                <li>
                <input type="radio" name="likert-'; echo $page_id; echo '-5" value="neutral">
                <label>Neutral</label>
                </li>

                 <li>
                <input type="radio" name="likert-'; echo $page_id; echo '-5" value="agree">
                <label>Agree</label>
                </li>

                <li>
                <input type="radio" name="likert-'; echo $page_id; echo '-5" value="strong_agree">
                <label>Strongly agree</label>
                </li>
